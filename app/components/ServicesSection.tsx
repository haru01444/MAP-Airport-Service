    ...
    <section id="services" style={{ padding: "100px 0", background: "#fff" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px" }}>
        ...
        <style dangerouslySetInnerHTML={{ __html: [
          ...
          "            .svc-top-wrap { flex-direction: column !important; align-items: flex-start !important; gap: 16px !important; margin-bottom: 24px !important; }",
          "            .svc-top-desc { margin-top: 0 !important; }",
          "            ",
                ...
                {current.airports.map((ap) => (
                  ...
                  >
                    ...
                    <div>
                      ...
                      {ap.isNew && (
                        <em style={{ display: "block", color: "#F5A623", fontSize: "0.7rem", fontStyle: "normal", fontWeight: 600, marginTop: 4 }}>
                          Baru · Feb 2024
                        </em>
                      )}
                    </div>
