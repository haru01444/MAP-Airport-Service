    ...
    <>
      ...
      <main>
        ...
        >
            ...
            <div className="animate-fade-in-up" style={{ width: "100%", display: "flex", flexDirection: "column", alignItems: "center" }}>
              ...
              >
                <i
                  ...
                  style={{ color: "#F5A623", fontSize: "0.78rem" }}
                />
                <span
                  style={{
                    color: "#F5A623",
              ...
              >
                ...
                dan siap beroperasi di standar industri penerbangan
                internasional.
              </p>
          ...
          <div
            style={{
              ...
              right: 0,
              height: 80,
              background: "#F8FAFC", /* Match About section background */
        ...
        <section id="about" style={{ padding: "120px 0 100px", background: "#F8FAFC", scrollMarginTop: "80px", position: "relative", overflow: "hidden" }}>
          {/* Decorative faint airplane watermark */}
          ...
          {/* Decorative yellow stripes top right */}
            ...
            >
              <div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 20, marginBottom: 40 }}>
                  {[
                    {
                      title: "Sertifikasi resmi berstandar nasional",
                      desc: "Pelatihan dengan standar kompetensi yang diakui secara nasional.",
                      icon: "fa-shield-halved"
                    },
                    {
                      title: "Instruktur dari praktisi maskapai aktif",
                      desc: "Dibimbing langsung oleh profesional industri penerbangan.",
                      icon: "fa-user-graduate"
                    },
                    {
                      title: "Fasilitas praktik riil operasional bandara",
                      desc: "Belajar dengan peralatan dan suasana kerja yang sebenarnya.",
                      icon: "fa-users"
                    },
                  ].map((item, idx) => (
              ...
              {[
                ...
                >
                  ...
                  <div>
                    <div style={{ display: "flex", alignItems: "baseline", gap: 8 }}>
                      <span
                        style={{
                          ...
                          fontSize: "1.6rem",
                          fontWeight: 800,
                          color: s.highlight ? "#D97706" : "#1D4ED8",
                          lineHeight: 1,
                        }}
                      >
                        {s.num}
                    ...
                    <span style={{ color: "#1E293B", fontSize: "0.85rem", fontWeight: 700, display: "block", marginTop: 6, marginBottom: 4 }}>
                      {s.label}
                    </span>
                    <p style={{ color: "#64748B", fontSize: "0.75rem", lineHeight: 1.5, margin: 0, paddingRight: 16 }}>
                      {s.desc}
                    </p>
                  </div>
                  ...
                  {/* Vertical Divider */}
                  {i < 3 && (
                    <div style={{ position: "absolute", right: -12, top: "10%", height: "80%", width: 1, background: "#E2E8F0" }} />
                  )}
                </div>
              ))}
            </div>
                ...
                >
                  ...
                  >
                    <i
                      ...
                      style={{ color: "#1D4ED8", fontSize: "1.3rem" }}
                    />
                  </div>
                  <div>
                    <h3
        ...
        >
          ...
          <div style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", width: 800, height: 800, borderRadius: "50%", border: "1px dashed rgba(255,255,255,0.15)", zIndex: 0, animation: "spin-slow 30s linear infinite" }} />
          <div style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", width: 1200, height: 1200, borderRadius: "50%", border: "1px solid rgba(255,255,255,0.05)", zIndex: 0, animation: "pulse-breathe 8s ease-in-out infinite" }} />
          <div style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", width: 1600, height: 1600, borderRadius: "50%", border: "2px dashed rgba(245,166,35,0.2)", zIndex: 0, animation: "spin-slow-reverse 40s linear infinite" }} />
          ...
          >
            ...
            >
              Program
              <br />
              <span style={{ color: "#F5A623" }}>Pelatihan</span>
            </h2>
            ...
            >
              4 program pelatihan dirancang bersama praktisi industri untuk
              memenuhi standar kompetensi aviasi nasional dan internasional.
            </p>
          </div>
        </section>
                  ...
                  >
                    {prog.items.map((item, i) => (
                      ...
                      >
                        ...
                        <span style={{ lineHeight: 1.4 }}>{(item as any).text}</span>
                      </li>
                    ))}
                  </ul>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
                    <a
                      ...
                      style={{
                        ...
                        fontSize: "0.85rem",
                        textDecoration: "none",
                        boxShadow: `0 8px 24px ${prog.bgColor}`,
                        flexShrink: 0,
                      }}
                    >
        ...
        <section
          ...
          style={{
            padding: "100px 0",
            background: "linear-gradient(135deg, #041235 0%, #082567 100%)",
            position: "relative",
            overflow: "hidden",
          }}
        >
          {/* Subtle Wireframe Background Curves */}
          ...
          <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px", position: "relative", zIndex: 1 }}>
            <div style={{ textAlign: "center", marginBottom: 64 }}>
              ...
              >
                Didukung fasilitas modern dan lengkap untuk memastikan kualitas
                ...
                >
                  ...
                  >
                    <i
                      ...
                      style={{ color: i % 2 === 0 ? "#4A9EF5" : "#F5A623", fontSize: "1.3rem" }}
                    />
                  </div>
                  <h3
                    style={{
          ...
          <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px" }}>
            ...
            >
              <div>
                ...
                >
                  Setiap peserta yang menyelesaikan program pelatihan akan
                  mendapatkan sertifikat kompetensi yang diakui oleh industri
                  penerbangan nasional dan sesuai dengan regulasi otoritas
                ...
                >
                  {[
                    {
                      icon: "fa-ribbon",
                      text: "Sertifikat Kompetensi Keahlian",
                      sub: "Diakui oleh industri aviasi nasional",
                    },
                    {
                      icon: "fa-file-lines",
                      text: "Sertifikat Kelulusan Pelatihan",
                      sub: "Diterbitkan oleh MAP Training Center",
                    },
                    {
                      icon: "fa-address-card",
                      text: "Kartu Tanda Peserta",
                      sub: "Valid selama masa pelatihan berlangsung",
                    },
                  ].map((item, i) => (
                    <div
                      key={i}
              ...
              <div style={{ padding: "20px" }}>
                ...
                >
                  ...
                  >
                    ...
                    {/* Faint Background Grid/Wireframe */}
                    <div style={{ position: "absolute", top: 0, left: 0, right: 0, bottom: 0, background: "radial-gradient(circle at 50% 50%, rgba(255,255,255,0.03) 1px, transparent 1px)", backgroundSize: "20px 20px", opacity: 0.5, pointerEvents: "none" }} />
                    ...
                    <div style={{ position: "relative", zIndex: 1 }}>
                      ...
                      >
                        Diberikan kepada peserta yang telah menyelesaikan program
                        pelatihan dengan hasil memuaskan dan memenuhi standar
                      ...
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginTop: 24 }}>
                        ...
                        <div style={{ background: "#F1F5F9", padding: 6, borderRadius: 6, display: "flex", alignItems: "center", justifyContent: "center" }}>
        ...
        >
          ...
          >
            ...
            >
              Hubungi kami sekarang untuk informasi pendaftaran, jadwal
              pelatihan, biaya program, dan kerja sama institusi. Tim kami siap
              membantu Anda.
            </p>
            <div
              style={{
